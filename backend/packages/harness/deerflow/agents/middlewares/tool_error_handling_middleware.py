...
def _build_runtime_middlewares(
    *,
    ...
    # UploadsMiddleware must come after ThreadDataMiddleware so it operates
    # on the already-annotated HumanMessage (run_id, timestamp) and the
    # uploads directory is guaranteed to exist when lazy_init=False.
